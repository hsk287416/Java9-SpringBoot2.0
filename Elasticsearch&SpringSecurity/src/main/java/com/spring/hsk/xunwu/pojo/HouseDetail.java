...
public class HouseDetail {
    ...
    public HouseDetail(Integer id, String description, String layoutDesc, String traffic, String roundService, Integer rentWay, String address, Integer subwayLineId, String subwayLineName, Integer subwayStationId, String subwayStationName, Integer houseId) {
        this.id = id;
