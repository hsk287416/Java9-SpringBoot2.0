...
public class House {
    ...
    public House(Integer id, String title, Integer price, Integer area, Integer room, Integer floor, Integer totalFloor, Integer watchTimes, Integer buildYear, Integer status, Date createTime, Date lastUpdateTime, String cityEnName, String regionEnName, String cover, Integer direction, Integer distanceToSubway, Integer parlour, String district, Integer adminId, Integer bathroom, String street) {
        this.id = id;
        this.title = title;
        this.price = price;
        this.area = area;
